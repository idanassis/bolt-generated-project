...
const education = [
  {
    ...
    endDate: '2026-10-01',
    description: 'Currently pursuing. Data Science and Signal Processing track.',
  },
  {
    ...
    endDate: '2024-10-01',
    description: 'Graduated with honors (cum laude). Grade: 94.12.\nDean\'s list for 3 consecutive years.',
  },
]
    ...
    <div className="flex">
      ...
      <div className="pb-8">
        ...
        {/* <p className="text-gray-700">{item.description}</p> */}
				<p className="text-gray-700" dangerouslySetInnerHTML={{ __html: item.description.replace(/\n/g, '<br />') }}></p>
      </div>
    </div>
  )
}
